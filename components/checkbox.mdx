...
<div class="checkbox-group">
  ...
  <label for="option1">Send me email notifications</label>
</div>

<!-- Checkbox with mixed state -->
<div class="checkbox-group">
  <input type="checkbox" id="parent" class="checkbox" indeterminate>
  <label for="parent">Select all items</label>
</div>
...
<fieldset class="checkbox-fieldset">
  ...
  <div class="checkbox-group">
    <input type="checkbox" id="email" class="checkbox" checked>
    <label for="email">Email notifications</label>
  </div>
  <div class="checkbox-group">
    <input type="checkbox" id="sms" class="checkbox">
    <label for="sms">SMS notifications</label>
  </div>
  <div class="checkbox-group">
    <input type="checkbox" id="push" class="checkbox">
...
| `value` | `string \| number` | - | Value for form submission |
...
<fieldset role="group" aria-labelledby="preferences-legend">
  <legend id="preferences-legend">Notification Preferences</legend>
  ...
  />
  <div id="sms-help" className="help-text">
